...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--plant-name", type=str, help="name of plant to water", required=True
    )
    parser.add_argument(
        "--needs-fertilizer",
        help="whether or not the plant needs fertilizing",
        action="store_true",
    )
    parser.add_argument(
        "--needs-water",
        help="whether or not the plant needs watering",
        action="store_true",
    )
